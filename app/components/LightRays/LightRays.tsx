...
void main() {
  ...
  gl_FragColor  = color;
        ...
        const updatePlacement = () => {
          ...
          renderer.dpr = Math.min(window.devicePixelRatio, isMobile ? 1 : 2);
        ...
        const loop = (t: number) => {
          ...
          if (followMouse && mouseInfluence > 0.0) {
            const smoothing = isMobile ? 0.95 : 0.92; // Less smoothing on mobile
        ...
        if (containerRef.current) {
          containerRef.current.innerHTML = `
            <div class="w-full h-full bg-gradient-to-b from-cyan-500/20 to-transparent pointer-events-none"></div>
          `;
        }
      }
    };
